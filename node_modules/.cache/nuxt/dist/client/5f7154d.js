(window.webpackJsonp=window.webpackJsonp||[]).push([[9],{448:function(S,x,s){"use strict";s.r(x);var f=function(){var v=this,o=v.$createElement,i=v._self._c||o;return i("canvas",{ref:"canvas",staticClass:"canvas",attrs:{"aria-label":"landing background"}})},p=[],n=s(324),h=`#define GLSLIFY 1
...
`,w=new n.a,g=2.3,c=!1,m=!1,u=!1,e=null,l=16/9,r=null,t=null,d=null,z={mounted:function(){var o=this,i=this.$refs.canvas;c=this.$prefersReducedMotion(),l=window.innerWidth/window.innerHeight,d=new n.f,e=new n.i({powerPreference:"high-performance",precision:"highp",canvas:i}),e.setPixelRatio(Math.min(window.devicePixelRatio,g)),e.outputEncoding=n.j,e.autoClearColor=new n.b(3,3,3),e.failIfMajorPerformanceCaveat=!0,r=new n.d(70,l,.5,2),r.position.set(0,0,1);var a=2,_=new n.e(a*l,a),R=new n.g({fragmentShader:h,vertexShader:y,extensions:{derivatives:"#extension GL_OES_standard_derivatives : enable"},uniforms:{time:{value:0},randomSeed:{value:Math.random()},objectOpacity:{value:c?1:0},noisePower:{value:1},pixelRatio:{value:window.devicePixelRatio},resolution:{value:new n.h(window.innerWidth,window.innerHeight)}},depthTest:!1});t=new n.c(_,R),d.add(t),r.matrixAutoUpdate=!1,t.matrixAutoUpdate=!1,window.addEventListener("resize",this.resize),this.resize(),this.$nuxt.$on("show-shader",function(){m=!0,o.$gsap.to(t.material.uniforms.objectOpacity,{value:1,duration:1.75,delay:.125})}),this.$gsap.ticker.add(this.render)},methods:{resize:function(){var o=e.domElement,i=o.clientWidth,a=o.clientHeight;(o.width!==i||o.height!==a)&&(e.setSize(i,a,!1),r.aspect=i/a,r.updateProjectionMatrix()),r.updateMatrix(),t.updateMatrix(),t.material.uniforms.resolution.value.set(window.innerWidth,window.innerHeight)},render:function(){this.$scrollY()-20>window.innerHeight||!m||c&&u||(c&&(u=!0),t.material.uniforms.time.value=w.getElapsedTime(),e.render(d,r))}}},C=z,P=s(34),b=Object(P.a)(C,f,p,!1,null,null,null),j=x.default=b.exports}}]);
