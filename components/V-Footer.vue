        ...
        <div ref="footerWrapper" class="footer__wrapper" data-scroll-sticky>
            <div ref="footerContent" class="footer__content">
                <p ref="footerContentTitle" class="footer__content__title">
                    Thanks for<br />
                    <span class="serif">visiting</span>
                </p>
                ...
                <p class="footer__content__note">Actualised in 2023</p>
            </div>
            <div
...
export default {
    ...
    data: () => ({
        socialLinks: [
            {
                label: 'LinkedIn',
                href: 'https://www.linkedin.com/in/diane-bouffard-vercelli/'
            },
            {
                label: 'github',
                href: 'https://github.com/dianubv'
            },
            {
                label: 'email',
            ...
            {
                label: 'IFT-website',
                href: 'https://dvic.devinci.fr/member/diane-bouffard-vercelli'
            }
        ]
    }),
    mounted() {
